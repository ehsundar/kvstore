...
type StaticPrimitiveBoolValue struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *StaticPrimitiveBoolValue) Reset() {
	*x = StaticPrimitiveBoolValue{}
	if protoimpl.UnsafeEnabled {
...
func (x *StaticPrimitiveBoolValue) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StaticPrimitiveBoolValue) ProtoMessage() {}

func (x *StaticPrimitiveBoolValue) ProtoReflect() protoreflect.Message {
	mi := &file_example_example_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StaticPrimitiveBoolValue.ProtoReflect.Descriptor instead.
func (*StaticPrimitiveBoolValue) Descriptor() ([]byte, []int) {
	return file_example_example_proto_rawDescGZIP(), []int{1}
}

func (x *StaticPrimitiveBoolValue) GetValue() bool {
	if x != nil {
		return x.Value
	}
	return false
...
var file_example_example_proto_rawDesc = []byte{
	...
	0x62, 0x6c, 0x65, 0x64, 0x22, 0x40, 0x0a, 0x18, 0x53, 0x74, 0x61, 0x74, 0x69, 0x63, 0x50, 0x72,
	0x69, 0x6d, 0x69, 0x74, 0x69, 0x76, 0x65, 0x42, 0x6f, 0x6f, 0x6c, 0x56, 0x61, 0x6c, 0x75, 0x65,
	0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x0e, 0xca, 0x3e, 0x0b, 0x12, 0x09, 0x66, 0x65, 0x61,
	0x74, 0x75, 0x72, 0x65, 0x2d, 0x78, 0x42, 0x25, 0x5a, 0x23, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_example_example_proto_goTypes = []interface{}{
	...
	(*StaticPrimitiveBoolValue)(nil), // 1: example.StaticPrimitiveBoolValue
}
...
func file_example_example_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_example_example_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StaticPrimitiveBoolValue); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
