...
type ValueForStaticKey struct {
	...
	Items  *ValueForStaticKey_NestedItems `protobuf:"bytes,3,opt,name=items,proto3" json:"items,omitempty"`
}

func (x *ValueForStaticKey) Reset() {
	*x = ValueForStaticKey{}
	if protoimpl.UnsafeEnabled {
...
func (x *ValueForStaticKey) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ValueForStaticKey) ProtoMessage() {}

func (x *ValueForStaticKey) ProtoReflect() protoreflect.Message {
	mi := &file_example_example_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ValueForStaticKey.ProtoReflect.Descriptor instead.
func (*ValueForStaticKey) Descriptor() ([]byte, []int) {
	return file_example_example_proto_rawDescGZIP(), []int{1}
}

func (x *ValueForStaticKey) GetValue() bool {
	if x != nil {
		return x.Value
	}
	return false
...
func (x *ValueForStaticKey) GetPhones() []string {
	if x != nil {
		return x.Phones
	}
	return nil
...
func (x *ValueForStaticKey) GetItems() *ValueForStaticKey_NestedItems {
	if x != nil {
		return x.Items
	}
	return nil
...
func (x *ValueForStaticKey_NestedItems) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
// Deprecated: Use ValueForStaticKey_NestedItems.ProtoReflect.Descriptor instead.
func (*ValueForStaticKey_NestedItems) Descriptor() ([]byte, []int) {
	return file_example_example_proto_rawDescGZIP(), []int{1, 0}
}

func (x *ValueForStaticKey_NestedItems) GetItems() []int32 {
	if x != nil {
		return x.Items
	}
	return nil
...
var file_example_example_proto_rawDesc = []byte{
	...
	,
	...
	0x0a, 0x09, 0x66, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x2d, 0x78, 0x22, 0x6f, 0x0a, 0x0a, 0x44,
	...
	0x03, 0x52, 0x06, 0x62, 0x75, 0x63, 0x6b, 0x65, 0x74, 0x3a, 0x11, 0xc2, 0x3e, 0x0e, 0x0a, 0x0a,
	0x72, 0x61, 0x74, 0x65, 0x2d, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x1a, 0x00, 0x22, 0x4d, 0x0a, 0x0e,
...
func file_example_example_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_example_example_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ValueForStaticKey); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
